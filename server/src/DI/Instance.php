...
class Instance
{
     ...
     * If null, the method will first try `Battleship::$app` then `Battleship::$container`.
    ...
    public function get($container = null)
    {
        ...
        if (Battleship::$app && Battleship::$app->has($this->id)) {
            return Battleship::$app->get($this->id);
        } else {
            return Battleship::$container->get($this->id);
        }
    }
}